...
Model = as.factor(c("raw","10p","30p","50p","70p","90p"))
model_comp_plot_ger = data.frame(aic_diff,Model)

model_comp_plot_ger$Model = factor(model_comp_plot_ger$Model, levels=levels(model_comp_plot_ger$Model)[c(1,2,3,4,5,6)], ordered=TRUE)
...
Model = as.factor(c("original","10p","30p","50p","70p","70p"))
