...
summary(m_group_log)
#15p
m_group_log_15p = (lmer(log(rt)~scale(py_ope_ger_binary_th_15p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_15p)|string),data=dat_lexdec))
summary(m_group_log_15p)
#20p
m_group_log_20p = (lmer(log(rt)~scale(py_ope_ger_binary_th_20p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_20p)|string),data=dat_lexdec))
summary(m_group_log_20p)
#25p
m_group_log_25p = (lmer(log(rt)~scale(py_ope_ger_binary_th_25p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_25p)|string),data=dat_lexdec))
...
#35p
m_group_log_35p = (lmer(log(rt)~scale(py_ope_ger_binary_th_35p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_35p)|string),data=dat_lexdec))
summary(m_group_log_35p)
#40p
m_group_log_40p = (lmer(log(rt)~scale(py_ope_ger_binary_th_40p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_40p)|string),data=dat_lexdec))
summary(m_group_log_40p)
#45p
m_group_log_45p = (lmer(log(rt)~scale(py_ope_ger_binary_th_45p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_45p)|string),data=dat_lexdec))
...
#55p
m_group_log_55p = (lmer(log(rt)~scale(py_ope_ger_binary_th_55p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_55p)|string),data=dat_lexdec))
summary(m_group_log_55p)
#60p
m_group_log_60p = (lmer(log(rt)~scale(py_ope_ger_binary_th_60p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_60p)|string),data=dat_lexdec))
summary(m_group_log_60p)
#65p
m_group_log_65p = (lmer(log(rt)~scale(py_ope_ger_binary_th_65p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_65p)|string),data=dat_lexdec))
...
#75p
m_group_log_75p = (lmer(log(rt)~scale(py_ope_ger_binary_th_75p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_75p)|string),data=dat_lexdec))
summary(m_group_log_75p)
#80p
m_group_log_80p = (lmer(log(rt)~scale(py_ope_ger_binary_th_80p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_80p)|string),data=dat_lexdec))
summary(m_group_log_80p)
#85p
m_group_log_85p = (lmer(log(rt)~scale(py_ope_ger_binary_th_85p)*group_num+scale(npix)*group_num+err+freq+(1|vp)+(scale(py_ope_ger_binary_th_85p)|string),data=dat_lexdec))
summary(m_group_log_85p)

#Model comparison: 
aic_ger = anova(Null_model,m_group_log,m_group_log_15p,m_group_log_20p,m_group_log_25p,m_group_log_30p,m_group_log_35p,m_group_log_40p,m_group_log_45p,m_group_log_50p,m_group_log_55p,m_group_log_60p,m_group_log_65p,m_group_log_70p,m_group_log_75p,m_group_log_80p,m_group_log_85p)
aic_ger
```
```{r}
...
Model = as.factor(c("15p","20p","25p","30p","35p","40p","45p","50p","55p","60p","65p","70p","75p","80p","85p"))
...
Model = as.factor(c("15p","20p","Both"))
model_comp_plot_ger = data.frame(aic_diff,Model)
...
#10p
deg_lum_ope_model_deg0_10p = (lmer(log(time)~scale(py_ope_ger_binary_th_10p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_10p)

#15p
deg_lum_ope_model_deg0_15p = (lmer(log(time)~scale(py_ope_ger_binary_th_15p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_15p)

#20p
deg_lum_ope_model_deg0_20p = (lmer(log(time)~scale(py_ope_ger_binary_th_20p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_20p)

#25p
deg_lum_ope_model_deg0_25p = (lmer(log(time)~scale(py_ope_ger_binary_th_25p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_25p)

#30p
deg_lum_ope_model_deg0_30p = (lmer(log(time)~scale(py_ope_ger_binary_th_30p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_30p)

#35p
deg_lum_ope_model_deg0_35p = (lmer(log(time)~scale(py_ope_ger_binary_th_35p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_35p)

#40p
deg_lum_ope_model_deg0_40p = (lmer(log(time)~scale(py_ope_ger_binary_th_40p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_40p)

#45p
deg_lum_ope_model_deg0_45p = (lmer(log(time)~scale(py_ope_ger_binary_th_45p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_45p)

#50p
deg_lum_ope_model_deg0_50p = (lmer(log(time)~scale(py_ope_ger_binary_th_50p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_50p)

#55p
deg_lum_ope_model_deg0_55p = (lmer(log(time)~scale(py_ope_ger_binary_th_55p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_55p)

#60p
deg_lum_ope_model_deg0_60p = (lmer(log(time)~scale(py_ope_ger_binary_th_60p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_60p)

#65p
deg_lum_ope_model_deg0_65p = (lmer(log(time)~scale(py_ope_ger_binary_th_65p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_65p)

#70p
deg_lum_ope_model_deg0_70p = (lmer(log(time)~scale(py_ope_ger_binary_th_70p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_70p)

#75p
deg_lum_ope_model_deg0_75p = (lmer(log(time)~scale(py_ope_ger_binary_th_75p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_75p)

#80p
deg_lum_ope_model_deg0_80p = (lmer(log(time)~scale(py_ope_ger_binary_th_80p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_80p)

#85p
deg_lum_ope_model_deg0_85p = (lmer(log(time)~scale(py_ope_ger_binary_th_85p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))

summary(deg_lum_ope_model_deg0_85p)

#90p
deg_lum_ope_model_deg0_90p = (lmer(log(time)~scale(py_ope_ger_binary_th_90p)*group_num+scale(npix)*group_num+freq+err+(1|vp)+(1|stim),subset(dat_lexdec_ger2,dat_lexdec_ger2$cond=="0%")))
...
Model = as.factor(c("original","10p","15p","20p","25p","30p","35p","40p","45p","50p","55p","60p","65p","70p","75p","80p","85p"))
model_comp_plot_ger = data.frame(aic_diff,Model)
